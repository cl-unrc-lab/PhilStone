...
public class U extends TemporalFormula {
	public U(Formula e1, Formula e2){
        super(e1,e2);	
	}
	...
	public String toString(){
		return "["+ this.getExpr1().toString() + "U"+ this.getExpr2().toString() +"]";
	}
	...
	public Formula removeVarOwnedBy(LinkedList<String> instances){
		return new U(this.getExpr1().removeVarOwnedBy(instances), this.getExpr2().removeVarOwnedBy(instances));
	}
