...
n1, n2n1, n3n1, p1n2, p2n2, p3n3, p4n3, p5n4, n4n1: prim_boolean;
...
process node4{
    parity:boolean;
    owns: n4n1;
    init: !this.parity &&  !global.n4n1 && !global.p5n4; 
    ...
    invariant: AG[EF[this.parity]] && AG[EF[!this.parity]] && AG[!global.p5n4 || EF[global.n4n1]];
}
...
process proc5{
    parity,finish:boolean;
    owns:p5n4;
     init: !this.finish && !this.parity && !global.n1 && !global.p5n4; 
     
     action finish0(){
         frame: finish, p5n4;
         pre: !this.finish;/* && !this.parity;*/
         post: this.finish && global.p5n4;
     }
     ...
     invariant: AG[EF[this.parity]] && AG[EF[!this.parity]] && AG[EF[global.p5n4]]  && AG[EF[!global.p5n4]];
 }
