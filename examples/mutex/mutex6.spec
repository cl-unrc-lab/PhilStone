...
property: AG[!(p1.st=Cs&&p2.st=Cs)]&&AG[!(p1.st=Cs&&p3.st=Cs)]&&AG[!(p1.st=Cs&&p4.st=Cs)]&&AG[!(p1.st=Cs&&p5.st=Cs)]&&AG[!(p1.st=Cs&&p6.st=Cs)]&&AG[!(p2.st=Cs&&p3.st=Cs)]&&AG[!(p2.st=Cs&&p4.st=Cs)]&&AG[!(p2.st=Cs&&p5.st=Cs)]&&AG[!(p2.st=Cs&&p6.st=Cs)]&&AG[!(p3.st=Cs&&p4.st=Cs)]&&AG[!(p3.st=Cs&&p5.st=Cs)]&&AG[!(p3.st=Cs&&p6.st=Cs)]&&AG[!(p4.st=Cs&&p5.st=Cs)]&&AG[!(p4.st=Cs&&p6.st=Cs)]&&AG[!(p5.st=Cs&&p6.st=Cs)]&&EF[p1.st=Cs||p2.st=Cs||p3.st=Cs||p4.st=Cs||p5.st=Cs||p6.st=Cs];