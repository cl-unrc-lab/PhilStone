...
property: !EF[phil1.own(left) && phil2.own(left) && phil3.own(left) && phil4.own(left) && phil5.own(left)] && !EF[phil1.own(right) && phil2.own(right) && phil3.own(right) && phil4.own(right) && phil4.own(right)] && AG[AF[(phil1.st=Eating) || (phil2.st=Eating) || (phil3.st=Eating) || (phil4.st=Eating) || (phil5.st=Eating)]];
