...
property :AG[!(pr1.st=Reading&&pw1.st=Writing)]&&AG[!(pr1.st=Reading&&pw2.st=Writing)]&&AG[!(pw1.st=Writing&&pw2.st=Writing)] && EF[(pr1.st = Reading)||(pw1.st = Writing)||(pw2.st = Writing)]&& AG[!(pw1.st = Writing) || EF[pw1.st = Waiting]]&& AG[!(pw2.st = Writing) || EF[pw2.st = Waiting]]&& AG[!(pr1.st = Reading) || EF[pr1.st = Waiting]];