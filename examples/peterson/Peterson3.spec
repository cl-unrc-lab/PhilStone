spec peterson
turn, try1, try2, try3 : prim_boolean;
process proc1{
    cs:boolean;
    owns:try1;
...
process proc2{
    cs:boolean;
    owns:try2;
	init: !this.cs &&  !global.turn && !global.try2 && !global.try3;
...
process proc3{
    cs:boolean;
    owns:try3;
	init: !this.cs &&  !global.turn && !global.try1 && !global.try3;

     action setTryTurn(){
		frame: turn, try3;
		pre: !this.cs && !global.try3;
		post: !global.turn && global.try3;
	}
...
property: AG[!p1.cs || !p2.cs] && AG[!global.try1 || AF[p1.cs]] && AG[!global.try2 || AF[p2.cs]] && AG[!global.try3 || AF[p3.cs]];
