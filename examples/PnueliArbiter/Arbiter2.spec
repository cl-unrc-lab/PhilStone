...
process process1{
    ...
    invariant: AG[EF[global.send2]] && AG[EF[this.hasToken]];
}
...
process process2{
    ...
    invariant:  AG[EF[global.send1]] && AG[EF[this.hasToken]];
}
...
assumption: /*    G[!global.r1 || p1.g1 || [global.r1 W  p1.g1]]   Requests keeps hight until a grant is given*/
            ...
            /* && G[F[!p2.g2 || !global.r2]];*/
            G[F[p1.hasToken]] && G[F[p2.hasToken]]; /* this last optimization is not needed */