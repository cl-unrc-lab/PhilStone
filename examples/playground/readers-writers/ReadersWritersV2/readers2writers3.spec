...
property: G[(!(r1.st=Reading) || !w1.writing) && (!(r2.st=Reading)|| !w1.writing) && (!(r1.st=Reading) || !w2.writing) && (!(r2.st=Reading)|| !w2.writing) && (!w2.writing || !w1.writing) && (!(r1.st=Reading) || !w3.writing) && (!(r2.st=Reading)|| !w3.writing) && 
(!w2.writing || !w3.writing) && (!w1.writing || !w3.writing)] 
&& G[!(r1.st = Waiting) || F[r1.st = Reading]]  /* if a reader is waiting, it will eventually read*/
&& G[!(r2.st = Waiting) || F[r2.st = Reading]]
&& F[r1.st = Reading || r2.st = Reading || w1.writing || w2.writing || w3.writing]; /* some proces will read or write, no fairness for this example */
