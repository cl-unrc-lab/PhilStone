/*
Notes: with separated actions for locks it is sat for 25 and 2 it
*/
...
property: G[(!(r1.st=Reading) || !w1.writing) && (!(r2.st=Reading)|| !w1.writing)] 
&& G[!(r1.st = Waiting) || F[r1.st = Reading]]
&& G[!(r2.st = Waiting) || F[r2.st = Reading]]
&& F[r1.st=Reading || r2.st=Reading || w1.writing];
