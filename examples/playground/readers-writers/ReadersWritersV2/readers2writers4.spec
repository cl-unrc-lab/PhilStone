...
property: G[(!(r1.st=Reading) || !w1.writing) /* Safety property: No Readers and Writers at the same time */
            ...
            && (!w4.writing || !w3.writing) 
            && (!w4.writing || !w2.writing)
            && (!w4.writing || !w1.writing) 
            && (!(r1.st=Reading)|| !w4.writing) 
            && (!(r2.st=Reading) || !w4.writing) 
           ] 
   && G[!(r1.st = Waiting) || F[r1.st = Reading]]  /* if a reader is waiting, it will eventually read*/
   && G[!(r2.st = Waiting) || F[r2.st = Reading]]
   && F[r1.st = Reading || r2.st = Reading || w1.writing || w2.writing || w3.writing || w4.writing]; 
